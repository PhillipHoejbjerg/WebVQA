...
class TestBERTProcessors(unittest.TestCase):
    ...
    def test_bert_tokenizer(self):
        from app.mmf.mmf.datasets.processors.bert_processors import BertTokenizer
    ...
    def test_vilt_tokenizer(self):
        from app.mmf.mmf.datasets.processors.bert_processors import VILTTextTokenizer
    ...
    def test_uniter_tokenizer(self):
        from app.mmf.mmf.datasets.processors.bert_processors import UNITERTextTokenizer
    ...
    def test_vinvl_tokenizer(self):
        from app.mmf.mmf.datasets.processors.bert_processors import VinVLTextTokenizer
