...
Example::
    ...
    from app.mmf.mmf.modules.metrics import BaseMetric
...
import torch
from app.mmf.mmf.common.registry import registry
from app.mmf.mmf.datasets.processors.processors import EvalAIAnswerProcessor
...
class Metrics:
    ...
    def __init__(self, metric_list):
        ...
        # todo:
        from app.mmf.mmf.utils.configuration import get_global_config
        self.config = get_global_config()
        if self.config.model == 'qlarifais': # todo: more general?
            from app.mmf.mmf.utils.build import build_graph_encoder, build_processors
...
class TextVQAAccuracy(BaseMetric):
    ...
    def calculate(self, sample_list, model_output, *args, **kwargs):
        ...
        predictions = []
        from app.mmf.mmf.utils.distributed import byte_tensor_to_object
...
class DetectionMeanAP(BaseMetric):
    ...
    **Key:** ``detection_mean_ap``
    ...
    def calculate(
        ...
        # mAP evaluation)
        from app.mmf.mmf.utils.distributed import broadcast_tensor, is_master
        from app.mmf.mmf.utils.general import get_current_device
