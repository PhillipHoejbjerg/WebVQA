...
class Registry:
    ...
    def register_trainer(cls, name):
        ...
        Usage::
            ...
            from app.mmf.mmf.common.registry import registry
            from app.mmf.mmf.trainers.custom_trainer import CustomTrainer
    ...
    def register_callback(cls, name):
        ...
        Usage::
            ...
            from app.mmf.mmf.common.registry import registry
            from app.mmf.mmf.trainers.callbacks.base import Callback
    ...
    def register_processor(cls, name):
        ...
        def wrap(func):
            from app.mmf.mmf.datasets.processors.processors import BaseProcessor
    ...
    def register_decoder(cls, name):
        ...
        Usage::
            ...
            from app.mmf.mmf.common.registry import registry
            from app.mmf.mmf.utils.text import TextDecoder
    ...
    def register_iteration_strategy(cls, name):
        ...
        Usage::
            ...
            from app.mmf.mmf.common.registry import registry
            from app.mmf.mmf.datasets.iterators import IterationStrategy
        ...
        def wrap(iteration_strategy_cls):
            from app.mmf.mmf.datasets.iteration_strategies import IterationStrategy
