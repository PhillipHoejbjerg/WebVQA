...
import numpy as np
import torch
from app.mmf.mmf.common.constants import IMAGE_COLOR_MEAN, IMAGE_COLOR_STD
from app.mmf.mmf.common.registry import registry
from app.mmf.mmf.common.typings import ProcessorConfigType
from app.mmf.mmf.utils.configuration import get_mmf_cache_dir, get_mmf_env
from app.mmf.mmf.utils.distributed import is_main, synchronize
from app.mmf.mmf.utils.file_io import PathManager
from app.mmf.mmf.utils.logger import log_class_usage
from app.mmf.mmf.utils.text import VocabDict
from app.mmf.mmf.utils.vocab import Vocab, WordToVectorDict
...
class FastTextProcessor(VocabProcessor):
    ...
    def _download_model(self):
        ...
        import requests
        from app.mmf.mmf.common.constants import FASTTEXT_WIKI_URL
...
class SimpleWordProcessor(BaseProcessor):
    ...
    def __init__(self, *args, **kwargs):
        from app.mmf.mmf.utils.text import word_tokenize
...
class SimpleSentenceProcessor(BaseProcessor):
    ...
    def __init__(self, *args, **kwargs):
        from app.mmf.mmf.utils.text import tokenize
...
class BBoxProcessor(VocabProcessor):
    ...
    def __init__(self, config, *args, **kwargs):
        from app.mmf.mmf.utils.dataset import build_bbox_tensors
...
class PhocProcessor(VocabProcessor):
    ...
    def __init__(self, config, *args, **kwargs):
        from app.mmf.mmf.utils.phoc import build_phoc
...
class DETRImageAndTargetProcessor(BaseProcessor):
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        from app.mmf.mmf.datasets.processors import detection_transforms as T
