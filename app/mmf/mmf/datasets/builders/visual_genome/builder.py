...
from app.mmf.mmf.common.constants import VISUAL_GENOME_CONSTS
from app.mmf.mmf.common.registry import registry
from app.mmf.mmf.datasets.builders.visual_genome.dataset import VisualGenomeDataset
from app.mmf.mmf.datasets.builders.vqa2.builder import VQA2Builder
