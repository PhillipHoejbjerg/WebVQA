...
from app.mmf.mmf.modules.embeddings import (
    PreExtractedEmbedding,
    TextEmbedding,
    TwoBranchEmbedding,
)
from app.mmf.mmf.modules.layers import BranchCombineLayer, ClassifierLayer
from app.mmf.mmf.utils.build import build_image_encoder
