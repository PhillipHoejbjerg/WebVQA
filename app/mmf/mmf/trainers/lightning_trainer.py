...
from app.mmf.mmf.trainers.lightning_core.loop_callback import LightningLoopCallback
from app.mmf.mmf.utils.build import build_lightning_model
from app.mmf.mmf.utils.checkpoint import (
    get_ckpt_from_path,
    get_ckpt_path_from_folder,
    get_config_from_folder_or_ckpt,
)
from app.mmf.mmf.utils.checkpoint_updater import is_model_only_checkpoint
from app.mmf.mmf.utils.configuration import get_mmf_env
from app.mmf.mmf.utils.download import download_pretrained_model
from app.mmf.mmf.utils.file_io import PathManager
from app.mmf.mmf.utils.general import get_max_updates, print_model_parameters
from app.mmf.mmf.utils.logger import TensorboardLogger, setup_output_folder
...
class LightningTrainer(BaseTrainer):
    ...
    def is_zoo_path(self, path) -> bool:
        from app.mmf.mmf.utils.configuration import get_mmf_env, load_yaml
